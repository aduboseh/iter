# Iter Server — Release Notes (PUBLIC): v0.3.0 (Phase 4)

## Overview
This release focuses on external stability of the Iter MCP boundary: a clarified and stable API contract, deterministic behavior suitable for replay and audit, and documentation intended for external integrators.
