...
impl QuarantineController {
    ...
    pub fn enter_quarantine(&self, reason: QuarantineReason, last_valid_checkpoint: Option<Uuid>) {
...
mod tests {
    ...
    fn test_quarantine_activation() {
        ...
        assert!(matches!(
            state.reason,
            Some(QuarantineReason::EnergyDriftExceeded { .. })
        ));
    }
